...
namespace DuiLib {
	...
	void CMenuWnd::Init(CMenuElementUI* pOwner, STRINGorID xml, LPCTSTR pSkinType, POINT point, MenuEvent pMenuInfo)
	{
		m_BasedPoint = point;
		m_pOwner = pOwner;
		m_pLayout = NULL;
	...
	void CMenuElementUI::CreateMenuWnd()
	{
		...
		m_pWindow->Init(static_cast<CMenuElementUI*>(this), _T(""), _T(""), CDuiPoint(), nullptr);
	}
