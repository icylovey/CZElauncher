...
typedef void(_stdcall *MenuEvent)(HWND hWnd, MenuInfo* MenuInfo);
...
public:
	...
	void Init(CMenuElementUI* pOwner, STRINGorID xml, LPCTSTR pSkinType, POINT point, MenuEvent pMenuInfo);
