...
{
	const_cast<char*>("SSQ_AddressToFunctionName"),
	const_cast<char*>("SSQ_Cleanup"),
	const_cast<char*>("SSQ_GetIpPort"),
	const_cast<char*>("SSQ_LogThread"),
	const_cast<char*>("SSQ_OutputDebugString"),
	const_cast<char*>("SSQ_Startup")
};
